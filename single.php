    ...
    <?php while (have_posts()):
          ...
          <div class="subpage-hero">
            ...
            <div class="container">
              <div class="subpage-hero__wrapper">
                <h1 class="subpage-hero__title subpage-hero__title--archive"><?php echo apply_filters(
                  'the_title',
                  $hero_title,
                ); ?></h1>
      ...
      <?php else: ?>
        ...
        <div class="subpage-hero">
          ...
          <div class="container">
            <div class="subpage-hero__wrapper">
              <h1 class="subpage-hero__title subpage-hero__title--white"><?php echo apply_filters(
                'the_title',
                'Blog',
              ); ?></h1>
            </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-10 offset-lg-1">
                ...
                <div class="prev-and-next-posts <?php if (empty($prev_post)) {
                  echo 'prev-and-next-posts--no-prev';
                } ?> <?php if (empty($next_post)) {
   echo 'prev-and-next-posts--no-next';
 } ?>">
                  <div class="prev-and-next-posts__item <?php if (empty($prev_post)) {
                    echo 'prev-and-next-posts__item--blank';
                  } ?>">
                    <?php if (!empty($prev_post)): ?>
                      <div class="prev-and-next-posts__wrapper">
                        <div class="prev-and-next-posts__image">
                          <img src="<?php echo has_post_thumbnail($prev_post)
                            ? get_the_post_thumbnail_url($prev_post, 'medium')
                            : get_template_directory_uri() .
                              '/images/blog-placeholder.jpg'; ?>" alt="prev-and-next-posts image" class="object-fit-cover">
                          <a href="<?php echo get_permalink(
                            $prev_post->ID,
                          ); ?>" class="prev-and-next-posts__image-link"></a>
                        </div>
                        <div class="prev-and-next-posts__content">
                          <a href="<?php echo get_permalink(
                            $prev_post->ID,
                          ); ?>" class="prev-and-next-posts__title"><?php echo $prev_post->post_title; ?></a>
                          <a href="<?php echo get_permalink(
                            $prev_post->ID,
                          ); ?>" class="button button--single mt-4">Poprzedni wpis</a>
                        </div>
                      </div>
                    <?php endif; ?>
                  </div>
                  <div class="prev-and-next-posts__item <?php if (empty($next_post)) {
                    echo 'prev-and-next-posts__item--blank';
                  } ?>">
                    <?php if (!empty($next_post)): ?>
                      <div class="prev-and-next-posts__wrapper">
                        <div class="prev-and-next-posts__image">
                          <img src="<?php echo has_post_thumbnail($next_post)
                            ? get_the_post_thumbnail_url($next_post, 'medium')
                            : get_template_directory_uri() .
                              '/images/blog-placeholder.jpg'; ?>" alt="prev-and-next-posts image" class="object-fit-cover">
                          <a href="<?php echo get_permalink(
                            $next_post->ID,
                        ...
                        <div class="prev-and-next-posts__content">
                          <a href="<?php echo get_permalink(
                            $next_post->ID,
                          ); ?>" class="prev-and-next-posts__title"><?php echo $next_post->post_title; ?></a>
                          <a href="<?php echo get_permalink(
                            $next_post->ID,
                          ); ?>" class="button button--single mt-4">Następny wpis</a>
                        </div>
                      </div>
                    <?php endif; ?>
                  </div>
