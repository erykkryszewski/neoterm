                    ...
                    <div class="news__item">
                      ...
                      <div class="news__content">
                        <div>
                          ...
                          <a href="<?php the_permalink(); ?>" class="button button--light news__button"><?php _e(
  'Read more',
  'seoleadertheme',
); ?></a>
                      </div>
            ...
            <div class="col-lg-3 mt-5">
              <div class="blog-sidebar">
                <h3><?php esc_html_e('Search', 'seoleadertheme'); ?></h3>
                <?php get_sidebar('seoleadertheme-sidebar'); ?>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-9 mt-5">
            <h2><?php esc_html_e('No posts found', 'seoleadertheme'); ?></h2>
          </div>
          <div class="col-lg-3 mt-5">
            <div class="blog-sidebar">
              <h3><?php esc_html_e('Search', 'seoleadertheme'); ?></h3>
